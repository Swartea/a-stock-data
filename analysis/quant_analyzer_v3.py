...
# ============================================================
# PEG talk-text 已抽到 analysis.utils (P2-A Phase 5)
# - v3 顶部 from analysis.utils import _format_peg_talk 透传
# ============================================================


# ============================================================
# 三价位表 (债 2 修法, Task 5.2 + P0-A 规范整改) — 4 候选取最近者
# P2-A Phase 3 整改: compute_three_levels + 5 辅助函数已抽到 analysis.three_levels
